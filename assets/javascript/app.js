$(document).ready(function(){
    ...
    $('button').on('click', function() {
        ...
        var queryURL = "https://api.giphy.com/v1/gifs/search?q=" + wrestler + "&api_key=dc6zaTOxFJmzC&limit=3";
        ...
        $.ajax({
            ...
            .done(function(response) {
                ...
                for (var i = 0; i < results.length; i++) {
                    ...
                    wrestlerDiv.append(animalImage);
    ...
    var wrestlers = [''];
        ...
        $('#theButton').on('click', function(){
            ...
            var newButton = $("<button/>").addClass( "btn btn-info wrestler").attr('data-name',wrestlerButton).html(wrestlerButton).css({'margin': '5px'});
